...
int iQuantity = 0;
int iItemIndex = 0;
KitDetail cartItem = null;
try {
iItemIndex = Integer.parseInt(strItemIndex);
iQuantity = Integer.parseInt(strQuantity);
if(iQuantity>0) {
cartItem = (KitDetail)alCartItems.get(iItemIndex-1);
...
public void addCartItem(String coronakitid, String productid,
	String strProdCost, String strQuantity) {
double dblTotalCost = 0.0;
double dblUnitCost = 0.0;
int iQuantity = 0;
KitDetail cartItem = new KitDetail();
try {
dblUnitCost = Double.parseDouble(strProdCost);
iQuantity = Integer.parseInt(strQuantity);
if(iQuantity>0) {
dblTotalCost = dblUnitCost*iQuantity;
